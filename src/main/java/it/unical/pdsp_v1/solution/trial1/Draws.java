...
/**
 * this class intension is to print the graph in images 
 * in progress.......
 * @author gezu
 */
public class Draws {
       private int width = 800;//vrp_y
   ...
   public  void  drawRoutes(Solution s, String fileName) {
        ...
        String cst = "PDSP solution for "+s.NoOfOrders+ " orders with Cost: " + s.Cost;
        ...
        try
        {
            ImageIO.write(output, "PNG", f);
              ...
              Logger.getLogger(Draws.class.getName()).log(Level.SEVERE, null, ex);
        }
